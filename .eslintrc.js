module.exports = {
    ...
    globals: {
      ...
      __STAGE__: false,
      __BUILD_INFO__: false,
      __SSL_CERT_PATH__: false,
      __SSL_PASSPHRASE__: false,
    },
    ...
    rules: {
      ...
      // General
      'comma-dangle': [0, 'always-multiline'], // allow or disallow trailing commas
      'no-cond-assign': 1, // disallow assignment in conditional expressions
      'no-console': 0, // disallow use of console (off by default in the node environment)
      'no-const-assign': 2, // disallow assignment to const-declared variables
      'no-constant-condition': 0, // disallow use of constant expressions in conditionsindenttab
      ...
      'no-iterator': 1, // disallow usage of _iterator_ property
      ...
      'no-proto': 1, // disallow usage of  property
      ...
      // 'no-path-concat': 1, // disallow string concatenation with _dirname and _filename (off by default) (on by default in the node environment)
